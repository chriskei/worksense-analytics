...
import { Footer, RightContainer, FooterLink, List, LeftContainer, FooterButtonContainer } from '../footer/footer.styles.js'
            ...
            <Footer bg={bg}>
                <LeftContainer>
                    ...
                    <List>
                        ...
                        <li><FooterLink to="/our-products/">Products</FooterLink></li>
