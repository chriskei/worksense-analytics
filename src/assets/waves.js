...
const ProductsWaveBottom = () => {
  return (
    <svg viewBox="0 0 1440 524" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fillRule="evenodd" clipRule="evenodd" d="M3.84715e-05 403.199C-1.264e-05 403.859 -1.30074e-05 404.515 3.84715e-05 405.168C0.000490355 410.9 0.00493724 416.363 0.0141245 421.455C129.385 510.744 450.016 590.494 888 436.5C1085.62 367.018 1322.54 317.02 1440 421.446V252.535L1380.44 276.561C1320.44 300.767 1200.44 349.178 1080.44 300.767C1014.99 274.36 949.535 219.148 884.081 163.935C829.535 117.924 774.99 71.9138 720.444 42.5737C600.444 -21.9745 480.444 -5.83743 360.444 42.5737C240.445 90.9848 120.445 171.67 60.4446 212.013L60.4444 212.013L0.444444 252.355C0.444444 252.355 0.00477043 342.112 3.84715e-05 403.199Z" fill="url(#paint2_linear)" fillOpacity="0.2"/>
      <defs>
        <linearGradient id="paint2_linear" x1="1440.44" y1="377.074" x2="94.4445" y2="114.074" gradientUnits="userSpaceOnUse">
...
const ProductsWaveBackground = () => {
  return (
    <svg viewBox="0 0 1440 672" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M0 0H1440V569.446C1322.54 465.02 1085.62 515.018 888 584.5C450 738.5 129.362 658.739 0 569.446V0Z" fill="url(#paint4_linear)"/>
      <defs>
        <linearGradient id="paint4_linear" x1="-350.509" y1="-466.205" x2="865.845" y2="869.317" gradientUnits="userSpaceOnUse">
          <stop stopColor="#07A3B2"/>
          <stop offset="1" stopColor="#D9ECC7"/>
        </linearGradient>
      </defs>
...
export { LandingWaveBlue, LandingWaveGreen, ProductsWaveTop, ProductsWaveBottom, ProductsWaveBackground }
